/**
 * Browser half of `@deepseek-ai/dsh-client-ui-novel`: the novel reading view
 ...
 * @module @deepseek-ai/dsh-client-ui-novel/client
 */
...
import { NovelView } from './NovelView.tsx'
...
/**
 * Register the dictionaries and the `novel` conversation view entry.
