...
/** One DSH queue item the task board reconciles against. */
export type ProductionQueueEntry = Pick<QueuedMessage, 'id' | 'rpcId'>
 ...
 * @param queue - the current DSH queue preview entries.
