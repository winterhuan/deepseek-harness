...
const DSH_SKILL_BRIDGE = [
  ...
  'All seven upstream Creative specialist Roles are bundled. Invoke one with creative_role and a self-contained prompt.',
...
4. 需要架构、角色或研究工作时，通过 creative_role 调用已打包 Role；不要检查或
