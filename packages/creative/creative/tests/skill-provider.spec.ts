...
import { createDramaSkillProvider, createNovelToGameSkillProvider, createCreativeSkillProvider, createVideoRecapSkillProvider, parseBundledSkill } from '../src/skill-provider.js'
...
describe('Drama Skills bundled provider', () => {
  it('publishes the complete upstream short-drama workflow through DSH', async () => {
    ...
    expect(novel?.content).toContain('export package from story-import')
