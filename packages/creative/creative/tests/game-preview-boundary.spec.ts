...
const assets = 'http://127.0.0.1:4000/creative/game-preview/example/jin-ping-mei/'
...
describe('game preview security boundary', () => {
  ...
  it('confines the workspace API to the preview asset prefix', () => {
    ...
    expect(connect).not.toContain('/creative/workspace')
    expect(connect).not.toContain('/creative/file')
  })
})
