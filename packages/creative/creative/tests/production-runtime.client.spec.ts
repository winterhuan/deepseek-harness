...
describe('production runtime', () => {
  ...
  it('reconciles and reorders the delivery sequence while reporting missing shots', () => {
    const versions: ProductionMediaVersion[] = [{
      id: 'image-v1', targetId: 'SHOT-EP001-001', kind: 'image', url: '/creative/media', path: '剧集/EP001/制作成果/1.png',
    }, {
      id: 'video-v1', targetId: 'SHOT-EP001-001', kind: 'video', url: '/creative/media', path: '剧集/EP001/制作成果/1.mp4',
    }]
...
describe('paid-job reconciliation regressions', () => {
  ...
  it('clears the end-of-turn billing warning once outputs start landing', () => {
    ...
    const versions: ProductionMediaVersion[] = [{
      id: 'v1', targetId: 'SHOT-001', kind: 'video', url: '/creative/media', path: '剧集/EP001/制作成果/paid-2-001.mp4',
    }]
