---
name: game-concept
description: "Choose the game concept for a novel adaptation: compare player fantasies, core loops, genres, and prototype scope against the source. Use to decide what game a novel supports, compare concepts, or assess interactive narration. 小说改编游戏概念设计：比较类型、玩家体验与核心循环，确定可玩原型范围；不写代码、数值表或逐场关卡脚本。"
---
# 游戏概念设计
