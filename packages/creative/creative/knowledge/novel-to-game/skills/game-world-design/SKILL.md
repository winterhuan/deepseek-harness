...
description: "Turn a selected concept into GAME_DESIGN: player promise, core loop, world responses, systems, level pacing, feedback, failure, and prototype scope. Use for game world, gameplay, branching narrative, scene, dialogue, or consequence design. 游戏体验、系统与关卡设计：把已选概念收束为可实现的玩家体验；不写世界观百科、工程方案或美术方向。"
---
# 游戏体验与世界设计
