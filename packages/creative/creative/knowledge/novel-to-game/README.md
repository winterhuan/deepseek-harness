...
Three playable adaptations, each available in a browser right now and linked to the case study behind it: the source material, concept trade-offs, game and art direction, runnable source, and evidence from the playable paths.
