"""Own understanding-stage cache keys, source hashes, and statuses."""
...
def _merge_overview_into_scenes(scenes, overview_path):
    ...
    keeping the original frame description under `frame_description` for fallback and frame-level grounding.
