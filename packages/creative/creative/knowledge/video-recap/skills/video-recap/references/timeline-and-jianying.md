...
Schema v2 has these JianYing authoring fields. Other schema versions are rejected:
...
| Transition / mask / LUT | object or package name on a video/photo segment | referenced `transitions`; mask `common_mask`; LUT/skin-tone `effects` |
