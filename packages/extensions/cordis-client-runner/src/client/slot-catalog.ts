...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-creative-produce CreativeProduceCard id \'creative-produce\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-skill-viewer SkillViewerAction id \'skill-viewer\'',
  ...
  },
  {
    ...
    source: 'packages/client/ui-tool/src/client/contract/slots.ts:50',
  },
  {
    ...
    occupants: [
      ...
      'creative RoleToolView key \'creative_role\'',
      'creative ProductionToolView',
    ...
    replaceRisk: 'shadows-shipped-ui',
    example: 'ctx.slots.inject(\'tool.call.toolview\', () => ctx.slots.register(\n  { name: \'tool.call.toolview\', key: \'my_tool\', locale: NS },\n  MyToolView,\n))',
    source: 'packages/client/ui-tool/src/client/contract/slots.ts:30',
  },
  {
