...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'conversation/open-file': 'client-face file-opening waterfall — packages/client/ui-chat/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SkillViewerEntry: 'skills.md',
  SkillViewerGetRequest: 'skills.md',
  SkillViewerGetValue: 'skills.md',
  SkillViewerReferenceRequest: 'skills.md',
  SkillViewerReferenceValue: 'skills.md',
  SkillViewerReferences: 'skills.md',
  SkillViewerListRequest: 'skills.md',
  SkillViewerListValue: 'skills.md',
  SkillViewerResourceBase: 'skills.md',
