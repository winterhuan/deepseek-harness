...
interface ToolArgsMap {
  ...
  /** Read one exact, pinned Creative story-setup reference bundled with this plugin. This does not resolve project Skills or workspace files. */
  creative_bundled_reference: {
    /** The exact story-setup reference path named by the active bundled Role. */
    reference: "story-setup/references/agent-references/agent-quality.md" | "story-setup/references/agent-references/agent-reference-profiles.md" | "story-setup/references/agent-references/anti-ai-writing.md" | "story-setup/references/agent-references/banned-words.md" | "story-setup/references/agent-references/character-basics.md" | "story-setup/references/agent-references/character-design-methods.md" | "story-setup/references/agent-references/character-relations.md" | "story-setup/references/agent-references/dialogue-mastery.md" | "story-setup/references/agent-references/emotional-arc-design.md" | "story-setup/references/agent-references/format-and-structure.md" | "story-setup/references/agent-references/genre-prose-cards.md" | "story-setup/references/agent-references/genre-prose-cards/东方仙侠.md" | "story-setup/references/agent-references/genre-prose-cards/传统玄幻.md" | "story-setup/references/agent-references/genre-prose-cards/历史古代.md" | "story-setup/references/agent-references/genre-prose-cards/历史脑洞.md" | "story-setup/references/agent-references/genre-prose-cards/双男主.md" | "story-setup/references/agent-references/genre-prose-cards/古言脑洞.md" | "story-setup/references/agent-references/genre-prose-cards/古风世情.md" | "story-setup/references/agent-references/genre-prose-cards/女频悬疑.md" | "story-setup/references/agent-references/genre-prose-cards/女频种田.md" | "story-setup/references/agent-references/genre-prose-cards/宫斗宅斗.md" | "story-setup/references/agent-references/genre-prose-cards/年代.md" | "story-setup/references/agent-references/genre-prose-cards/快穿.md" | "story-setup/references/agent-references/genre-prose-cards/悬疑灵异.md" | "story-setup/references/agent-references/genre-prose-cards/悬疑脑洞.md" | "story-setup/references/agent-references/genre-prose-cards/战神赘婿.md" | "story-setup/references/agent-references/genre-prose-cards/抗战谍战.md" | "story-setup/references/agent-references/genre-prose-cards/星光璀璨.md" | "story-setup/references/agent-references/genre-prose-cards/民国言情.md" | "story-setup/references/agent-references/genre-prose-cards/游戏体育.md" | "story-setup/references/agent-references/genre-prose-cards/玄幻脑洞.md" | "story-setup/references/agent-references/genre-prose-cards/玄幻言情.md" | "story-setup/references/agent-references/genre-prose-cards/现言脑洞.md" | "story-setup/references/agent-references/genre-prose-cards/科幻末世.md" | "story-setup/references/agent-references/genre-prose-cards/职场婚恋.md" | "story-setup/references/agent-references/genre-prose-cards/西方奇幻.md" | "story-setup/references/agent-references/genre-prose-cards/豪门总裁.md" | "story-setup/references/agent-references/genre-prose-cards/都市修真.md" | "story-setup/references/agent-references/genre-prose-cards/都市日常.md" | "story-setup/references/agent-references/genre-prose-cards/都市种田.md" | "story-setup/references/agent-references/genre-prose-cards/都市脑洞.md" | "story-setup/references/agent-references/genre-prose-cards/都市高武.md" | "story-setup/references/agent-references/genre-prose-cards/青春甜宠.md" | "story-setup/references/agent-references/genre-readers.md" | "story-setup/references/agent-references/long-chapter-hooks.md" | "story-setup/references/agent-references/long-emotional-methods.md" | "story-setup/references/agent-references/long-genre-catalog.md" | "story-setup/references/agent-references/long-genre-mechanics.md" | "story-setup/references/agent-references/long-quality.md" | "story-setup/references/agent-references/long-reversal.md" | "story-setup/references/agent-references/long-suspense.md" | "story-setup/references/agent-references/opening-design.md" | "story-setup/references/agent-references/outline-conflict.md" | "story-setup/references/agent-references/outline-methods.md" | "story-setup/references/agent-references/outline-rhythm.md" | "story-setup/references/agent-references/plot-core-methods.md" | "story-setup/references/agent-references/short-chapter-hooks.md" | "story-setup/references/agent-references/short-emotional-methods.md" | "story-setup/references/agent-references/short-genre-formulas.md" | "story-setup/references/agent-references/short-paragraph-hooks.md" | "story-setup/references/agent-references/short-quality.md" | "story-setup/references/agent-references/short-reversal.md" | "story-setup/references/agent-references/short-suspense.md" | "story-setup/references/agent-references/style-combat-face.md" | "story-setup/references/agent-references/style-genre-modules.md" | "story-setup/references/agent-references/writing-craft.md";
  } & Record<string, JsonValue>;
  /** Run creative production with configured credentials; inspect creative_produce_status first to discover configured adapters. Agnes image generation uses entry drama and adapter agnes-image. Credentials are injected by DSH, not read from an ordinary bash environment. For drama, prepare and explicitly confirm the exact current job with production_tool.py, then supply its job_id and adapter. The run consumes that confirmation once, snapshots inputs, verifies outputs and writes the production ledger. Configured key pools rotate across calls; within one drama run only an explicit authentication, permission or rate-limit rejection of the initial submission may switch keys, bounded at sixteen attempts. Accepted submissions, polling, downloads and uncertain failures are never automatically resubmitted. Video scripts retain their arguments and require creator confirmation before production. Use drama argv ["--selftest"] only for offline adapter diagnostics. */
  creative_produce_run: {
    /** Which script runs: confirmed drama production, video voiceover, recap, or doctor. */
    entry: "drama" | "video-voiceover" | "video-recap" | "video-doctor";
    /** Required for entry drama; must match the prepared job adapter. */
    adapter?: "gpt-image-2" | "minimax-h3" | "minimax-music" | "seedance" | "agnes-image" | "agnes-video";
    /** Prepared and explicitly confirmed drama job id. Required for drama production; not accepted by video entries or diagnostics. */
    job_id?: string;
    /** Video script arguments, or exactly ["--selftest"] for offline drama diagnostics. Drama production accepts no extra arguments. */
    argv?: string[];
    /** Input for video scripts. Drama reads its prepared job and never accepts replacement job JSON. */
    stdin?: string;
    /** Working directory; for drama, the prepared short-drama project or a directory inside it. Defaults to the session workspace. */
    workdir?: string;
    /** Executor timeout; background runs ignore it. */
    timeoutMs?: number;
    /** Return a produce job id immediately (collect with job_output, stop with job_kill). No executor timeout applies; adapters retain their own timeouts. */
    run_in_background?: boolean;
    /** Production request to bind to this run. Requires run_in_background: true and does not replace the prepared job confirmation. */
    production?: {
      /** Production request identity from the confirmed preparation. */
      requestId: string;
      /** Full workspace-relative episode path, including the book prefix. */
      episode: string;
      targetId: string;
      kind: "image" | "video" | "composition";
      /** Planned output count, not completed work. */
      expectedOutputs?: number;
      prompt?: string;
    };
  } & Record<string, JsonValue>;
  /** Inspect configured creative production credentials without exposing keys or running production. Use this before asking for a missing key or choosing an adapter. DSH injects credentials from its settings and credential store into creative_produce_run; checking os.environ in an ordinary bash process does not test that store. Credential presence does not validate provider connectivity or authorize a paid run. */
  creative_produce_status: Record<string, JsonValue>;
  /** Open or focus short-drama production targets, set an explicit shot order, or bind an existing background job to a confirmed production request. For track_job, start the background command first, then supply its actual JobId and the preparation requestId. The job must belong to the current Session. This tool does not generate media or authorize paid production. */
  creative_production: {
    /** The exact production UI/task projection operation. */
    action: "open_section" | "focus_target" | "set_sequence" | "track_job";
    /** Full workspace-relative episode directory, for example 书名/剧集/EP001. */
    episode: string;
    section?: "shots" | "assets" | "tasks" | "sequence" | "canvas";
    targetId?: string;
    shotIds?: string[];
    /** Actual framework job ID returned by an already started background command. */
    jobId?: string;
    /** Production request ID from the confirmed preparation; required for track_job. */
    requestId?: string;
    jobKind?: "image" | "video" | "composition";
    /** Planned output count. This is not execution progress or proof of output success. */
    expectedOutputs?: number;
    /** Exact prompt/specification for a tracked job; not a production authorization. */
    prompt?: string;
  } & Record<string, JsonValue>;
  /** Run one of the seven bundled novel-writing Roles as a child of the current DSH Agent. Load workflow Skills such as short-drama-develop with the skill tool; Skill names are not Role names. The child inherits DSH model, workspace, permissions, lifecycle, and UI. */
  creative_role: {
    /** One of the listed novel specialist Role names. */
    role: "chapter-extractor" | "character-designer" | "consistency-checker" | "narrative-writer" | "story-architect" | "story-explorer" | "story-researcher";
    /** A self-contained task. The child inherits the current DSH workspace but not the current in-flight turn. */
    prompt: string;
  } & Record<string, JsonValue>;
...
interface ToolOutputMap {
  ...
  creative_produce_run: {
    ...
    /** Produce job id; set only for background runs. */
    jobId?: string;
    /** Script exit code; set only for foreground runs. */
    exitCode?: number | null;
    /** Whether the executor timed out, independently of the exit code; set only for foreground runs. */
    timedOut?: boolean;
    /** Terminating signal, or null for a normal exit; set only for foreground runs. */
    signal?: string | null;
    /** Collected stdout; set only for foreground runs. */
    stdout?: string;
    /** Collected stderr; set only for foreground runs. */
    stderr?: string;
    production?: {
      /** Production request identity from the confirmed preparation. */
      requestId: string;
